...
public class DropdownLabelImpl<O extends Option<String>> extends DropdownAdapter<O> implements WidgetParent {
    ...
    private static final ResourceLocation TEXTURE_VANILLA_RESPACKS = new ResourceLocation("textures/gui/resource_packs.png");
    ...
    public void drawInLocalContext(Viewport viewport, int lmx, int lmy) {
        ...
        // Draw arrow
        {
            MC.renderEngine.bindTexture(TEXTURE_VANILLA_RESPACKS);
            GlStateManager.color(1, 1, 1, 1);

            int u = 82, v = 20 + (hover ? 32 : 0);
            drawModalRectWithCustomSizedTexture(getRight() - 16, getY() + getHeight() / 2 - 3, u, v, 11, 7, 256, 256);
        }
